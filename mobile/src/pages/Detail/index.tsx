...
const Detail = () => {
  ...
  const [data, setData] = useState<Data>({} as Data) // as indica que {} é do tipo data

  const routeParams = route.params as Params //Coloca como sendo da interface Params
  ...
  return(
    <SafeAreaView style={{flex: 1}}>
        <View style={styles.container}>
          ...
          <Icon name="arrow-left" size={25} color="#34cb79"></Icon>
          </TouchableOpacity>
          ...
          <View style={styles.footer}>
            ...
            <RectButton style={styles.button} onPress={() => {}}>
              ...
              <Text style={styles.buttonText} onPress={handleComposeEmail} >Email</Text>
            </RectButton>
          </View>
